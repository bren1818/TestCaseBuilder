...
*/
		...
		$query = "SELECT `id`, `testID`,`testName`,`pass`,`fail`,`taker`,`browser`,`device`
		...
		$data[] =  array(
			...
			$row["testID"], $row["testName"],  $row["pass"], $row["fail"], $row["taker"], $row["browser"], $row["device"], "<a href='modifyTestresult.php?testresultID=$id'>View</a><a href='deleteTestresult.php?testresultID=$id'>Delete</a>"
