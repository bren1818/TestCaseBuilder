...
<form name="modifyTestcase" id="modifyTestcase" method="POST" action="modifyTestcase.php" enctype="multipart/form-data">
	<div class="formRow">
		<div class="rowLabel">
	...
	<div class="formRow rowCenter">	<br /> <br />
		<input type="hidden" name="testcaseID" value="<?php echo $testcase->getID(); ?>" /> <input class="button" type="submit" value="Update" /> <a href="TestcaseAdmin.php">Cancel</a>
	</div>
